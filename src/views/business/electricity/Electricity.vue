<template>
  <a-card :bordered="false" class="card-area">
      ...
      <div class="operator">
        ...
        <a-dropdown v-hasAnyPermission="'electricity:export','electricity:add'">
          <a-menu slot="overlay">
            ...
            <a-menu-item v-hasPermission="'electricity:export'" key="export-data" @click="exportExcel">导出Excel</a-menu-item>
          </a-menu>
          <a-button>
    ...
    <electricity-add
      ...
      @close="handleElectricityAddClose"
      @success="handleElectricityAddSuccess">
    </electricity-add>
    <!-- 修改电费信息 -->
    <electricity-edit
      ref="electricityEdit"
      :electricityEditVisiable="electricityEdit.visiable"
      @close="handleElectricityEditClose"
...
export default {
  ...
  methods: {
    ...
    add () {
      this.electricityAdd.visiable = true
    },
    handleElectricityAddClose () {
      this.electricityAdd.visiable = false
    },
    handleElectricityAddSuccess () {
      this.electricityAdd.visiable = false
      this.$message.success('新增电费信息成功')
      this.search()
    },
    edit (record) {
      this.$refs.electricityEdit.setFormValues(record)
      this.electricityEdit.visiable = true
    },
    handleElectricityEditClose () {
      this.electricityEdit.visiable = false
    },
    handleElectricityEditSuccess () {
      this.electricityEdit.visiable = false
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        centered: true,
        onOk () {
          that.$delete('electricity/' + that.selectedRowKeys.join(',')).then(() => {
