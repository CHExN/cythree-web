<template>
  <a-card :bordered="false" class="card-area">
    ...
    <!-- 电动车信息查看 -->
    <car-electric-info
      :carElectricInfoData="carElectricInfo.data"
      :carElectricInfoVisiable="carElectricInfo.visiable"
      @close="handleCarElectricInfoClose">
    </car-electric-info>
    <!-- 新增电动车 -->
    <car-electric-add
      :carElectricAddVisiable="carElectricAdd.visiable"
      @close="handleCarElectricAddClose"
      @success="handleCarElectricAddSuccess">
    </car-electric-add>
    <!-- 修改电动车 -->
    <car-electric-edit
      ref="carElectricEdit"
      :carElectricEditVisiable="carElectricEdit.visiable"
      @close="handleCarElectricEditClose"
      @success="handleCarElectricEditSuccess">
    </car-electric-edit>
    <!-- 导入结果 -->
    <import-result
      @close="handleClose"
...
import CarElectricInfo from './CarElectricInfo'
import CarElectricAdd from './CarElectricAdd'
import CarElectricEdit from './CarElectricEdit'
import ImportResult from '@/components/view/ImportResult'

export default {
  name: 'CarElectric',
  components: { RangeDate, CarElectricInfo, CarElectricAdd, CarElectricEdit, ImportResult },
  data () {
    return {
      fileList: [],
      importData: [],
  ...
  methods: {
    ...
    downloadTemplate () {
      this.$download('carElectric/template', {}, '电动自行车表_导入模板.xlsx')
    },
    importExcel (file) {
      const formData = new FormData()
      formData.append('file', file)
      formData.append('ifThree', 2)
    ...
    view (record) {
      this.carElectricInfo.data = record
      this.carElectricInfo.visiable = true
    },
    add () {
      this.carElectricAdd.visiable = true
    },
    handleCarElectricAddClose () {
      this.carElectricAdd.visiable = false
    },
    handleCarElectricAddSuccess () {
      this.carElectricAdd.visiable = false
      this.$message.success('新增电动车成功')
      this.search()
    },
    edit (record) {
      this.$refs.carElectricEdit.setFormValues(record)
      this.carElectricEdit.visiable = true
    },
    handleCarElectricEditClose () {
      this.carElectricEdit.visiable = false
    },
    handleCarElectricEditSuccess () {
      this.carElectricEdit.visiable = false
      this.$message.success('修改电动车成功')
      this.search()
    },
    handleCarElectricInfoClose () {
      this.carElectricInfo.visiable = false
    },
