<template>
  <a-drawer
    ...
    @close="onClose"
    :closable="false"
    :visible="insuranceInsideListVisiable"
...
<script>
export default {
  name: 'InsuranceInsideList',
  props: {
    insuranceInsideListVisiable: {
      default: false
    }
  },
  data () {
  ...
  methods: {
    ...
    fetch (params = {}) {
      ...
      this.$get('insuranceInside/insuranceInsideSimplify', {
        ...params,
  ...
  watch: {
    insuranceInsideListVisiable () {
      if (this.insuranceInsideListVisiable) {
        this.fetch()
      }
    }
  }
