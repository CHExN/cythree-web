...
export default {
  ...
  methods: {
    ...
    // getDay () {
    //   let names = this.form.getFieldValue('names')
    //   console.log(names)
    //   let day = 0
    //   names.forEach(element => {
    //     console.log(`${element[0].format('YYYY-MM-DD')}~${element[1].format('YYYY-MM-DD')}`)
    //     day = day + element[1].diff(element[0], 'days') + 1
    //     console.log(element[1].diff(element[0], 'days') + 1)
    //   })
    //   this.form.getFieldDecorator('day')
